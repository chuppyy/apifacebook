...
/// <summary>
///     Command cập nhật thông báo hệ thống
/// </summary>
public class UpdateNotificationManagerCommand : NotificationManagerCommand
{
#region Constructors
    ...
    /// </summary>
    public UpdateNotificationManagerCommand(NotificationManagerEventModel model)
    {
        Id               = model.Id;
        Name             = model.Name;
