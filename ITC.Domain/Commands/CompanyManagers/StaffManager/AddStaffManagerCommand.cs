...
/// </summary>
public class AddStaffManagerCommand : StaffManagerCommand
{
#region Constructors
    ...
    /// </summary>
    public AddStaffManagerCommand(StaffManagerEventModel model)
    {
        Name              = model.Name;
        ...
        UserTypeManagerId = model.UserTypeManagerId;
