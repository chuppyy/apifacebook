...
public class EducationDepartmentUpdatedEvent : StoredEvent
{
#region Constructors

    public EducationDepartmentUpdatedEvent(StoredEventType eventType, string sourceId,   string sourceName,
