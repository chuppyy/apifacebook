...
[ApiController]
[Authorize]
public class FunctionSystemManagerController : ApiController
{
#region Constructors
    ...
    public FunctionSystemManagerController(IUser                                    user,
...
#region Methods
    ...
    /// <returns></returns>
    [HttpPost("create")]
    [CustomAuthorize(ModuleIdentity.FunctionSystemManager, TypeAudit.Add)]
    ...
    /// <returns></returns>
    [HttpPut("update")]
    [CustomAuthorize(ModuleIdentity.FunctionSystemManager, TypeAudit.Edit)]
    ...
    /// <returns></returns>
    [HttpDelete("delete")]
    [CustomAuthorize(ModuleIdentity.FunctionSystemManager, TypeAudit.Delete)]
    ...
    // [CustomAuthorize(ModuleIdentity.FunctionSystemManager, TypeAudit.View)]
    ...
    /// </summary>
    /// <returns></returns>
    // [CustomAuthorize(ModuleIdentity.MenuSystemManager, TypeAudit.View)]
    ...
    // [CustomAuthorize(ModuleIdentity.MenuSystemManager, TypeAudit.Add)]
    ...
    // [CustomAuthorize(ModuleIdentity.MenuSystemManager, TypeAudit.Edit)]
    ...
    // [CustomAuthorize(ModuleIdentity.MenuSystemManager, TypeAudit.Delete)]
