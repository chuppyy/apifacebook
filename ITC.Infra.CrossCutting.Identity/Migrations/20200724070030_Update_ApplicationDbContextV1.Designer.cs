...
namespace ITC.Infra.CrossCutting.Identity.Migrations
{
    ...
    [Migration("20200724070030_Update_ApplicationDbContextV1")]
    partial class Update_ApplicationDbContextV1
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ITC.Infra.CrossCutting.Identity.Models.ApplicationUser", b =>
                {
                    b.HasOne("ITC.Infra.CrossCutting.Identity.Models.UserType", "UserType")
                        .WithMany()
                        .HasForeignKey("UserTypeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
