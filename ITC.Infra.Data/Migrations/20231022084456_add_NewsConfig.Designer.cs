...
namespace ITC.Infra.Data.Migrations
{
    ...
    [Migration("20231022084456_add_NewsConfig")]
    partial class addNewsConfig
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ITC.Domain.Models.NewsManagers.NewsConfig", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasMaxLength(40)
                    ...
                    b.Property<string>("OwnerGit")
                        .HasMaxLength(250)
                        .HasColumnType("nvarchar(250)");

                    b.Property<string>("ProjectDefaultGit")
                        .HasMaxLength(250)
                        .HasColumnType("nvarchar(250)");
                    ...
                    b.Property<string>("TokenGit")
                        .HasMaxLength(250)
                        .HasColumnType("nvarchar(250)");

                    b.Property<string>("TokenVercel")
                        .HasMaxLength(250)
                        .HasColumnType("nvarchar(250)");

                    b.HasKey("Id");

                    b.ToTable("NewsConfigs", (string)null);
                });
            ...
            modelBuilder.Entity("ITC.Domain.Models.NewsManagers.NewsContent", b =>
                {
                    ...
                    b.Property<DateTime?>("TimeAutoPost")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("ITC.Domain.Models.NewsManagers.NewsDomain", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasMaxLength(40)
                    ...
                    b.ToTable("NewsDomains", (string)null);
                });

            modelBuilder.Entity("ITC.Domain.Models.NewsManagers.NewsGithub", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasMaxLength(40)
                    ...
                    b.ToTable("NewsGithubs", (string)null);
                });
            ...
            modelBuilder.Entity("ITC.Domain.Models.NewsManagers.NewsGroup", b =>
                {
                    ...
                    b.Property<string>("DomainVercel")
                        .HasMaxLength(500)
                        .HasColumnType("nvarchar(500)");
            ...
            modelBuilder.Entity("ITC.Domain.Models.NewsManagers.NewsVercel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasMaxLength(40)
                    ...
                    b.ToTable("NewsVercels", (string)null);
                });
