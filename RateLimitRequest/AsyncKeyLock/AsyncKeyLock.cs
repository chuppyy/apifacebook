...
/// <summary>
///     The async key lock prevents multiple asynchronous threads acting upon the same object with the given key at the
///     same time.
...
#region Static Fields and Constants
    ...
    /// </summary>
    private static readonly Dictionary<string, AsyncKeyLockDoorman> Keys = new();

    /// <summary>
    ///     A pool of unused doorman counters that can be re-used to avoid allocations.
    /// </summary>
    private static readonly Stack<AsyncKeyLockDoorman> Pool = new(MaxPoolSize);
