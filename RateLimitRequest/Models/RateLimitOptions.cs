...
#region Properties
    ...
    public List<string> EndpointBlacklist { get; set; }

    public List<string>        EndpointWhitelist { get; set; }
    public List<RateLimitRule> GeneralRules      { get; set; }

    /// <summary>
    ///     Gets or sets the HTTP Status code returned when rate limiting occurs, by default value is set to 429 (Too Many
    ///     Requests)
    /// </summary>
    ...
    /// </summary>
    public Func<HttpContext, ClientRequestIdentity, RateLimitCounter, RateLimitRule, Task> RequestBlockedBehavior
    {
        get;
        set;
    }
